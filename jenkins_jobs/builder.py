...
class Builder(object):
    ...
    def deploy_jobs(self, *args, **kwargs):
        """
        This method takes a list of XmlJobs and then deploys those jobs to the
        Jenkins configured for this instance of Builder, without invoking the
        YamlParser.
        """
        self.__update_jobs(*args, **kwargs)
